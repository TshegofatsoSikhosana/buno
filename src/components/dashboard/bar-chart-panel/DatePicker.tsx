...
function DatePicker() {
  ...
  return (
    <>
      ...
      <div className="inline-block w-100 p-2">
        {openForm ? (
          <>
            <div className="p-2 ">
              <div className="inline-block mr-2 w-4/12 p-2">
                ...
                <input
                  type="text"
                  className="text-black mr-3 w-6/12 inline-block"
                  value={year}
                />
                <div
                  className="btn-minus w-1/12 inline-block p-1 mr-1"
                  onClick={(e) => updateYear(year - 1)}
                >
                  {" "}
                  -
                </div>
                <div
                  className="btn-plus w-1/12 inline-block p-1"
                  onClick={(e) => updateYear(year + 1)}
                >
                  {" "}
                  +
              ...
              <div className="inline-block mr-2 w-4/12">
                ...
                <div
                  className="btn-minus w-1/12 inline-block p-1 mr-1"
                  onClick={(e) => updateMonth(Number(month - 1))}
                >
                  {" "}
                  -
                </div>
