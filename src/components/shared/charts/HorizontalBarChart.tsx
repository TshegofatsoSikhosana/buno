...
function HorizontalBarChart(props: BarChartProps) {
  ...
  return (
    <Bar data={{
      ...
      options={{
        layout: { padding: 2 },
        indexAxis: (props.horizontal === undefined || props.horizontal === true) ? 'y' : 'x',
        color: "white",
        scales: (props.horizontal === undefined || props.horizontal === true) ? {
          yAxes: {
            labels: props.labels,
            ticks: {
              color: 'white',
